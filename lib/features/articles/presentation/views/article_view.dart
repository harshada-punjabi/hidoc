...
class ArticleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ArticleCubit, ArticleState>(
      ...
      return SafeArea(
        child: Scaffold(
          body: Container(
            decoration: kIsWeb ? const BoxDecoration() :  const BoxDecoration(
                  ...
                  children: [
                   ...
                   const Text(
                    ...
                    Column(children: [
                      ...
                      _trendingBulletinListBuilder(article.data.trandingBulletin),
                     const SizedBox(height: 20,),
                      _readMoreBulletinsButton(context, 'Read More Bulletins'),
                     const SizedBox(height: 20,),
                          ...
                          trailing: ElevatedButton(onPressed: (){},style: ButtonStyle(
                            ...
                            shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                              RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16), // Set button border radius
                              ),
                            ),
  ...
  Widget _readMoreBulletinsButton(BuildContext context, String text) => SizedBox(
    ...
    child: ElevatedButton(
      ...
      child:  Text(text, style:const TextStyle(fontSize: 18, fontWeight: FontWeight.w300),),


    ),
  );
  Widget _latestArticle(BuildContext context, List<LatestArticleEntity>? latestArticleList){
    return Container(
  ...
  Widget _trendingArticle(BuildContext context, List<TrendingArticleEntity>? trendingArticlList){
    return Container(
            ...
            itemBuilder: (context, index) {
              if (index < trendingArticlList.length) {
                return Padding(
                  ...
                  child: Column(
                    children: [
                      Divider(thickness:index==0? 2:1,),
                     index == 0? Column(
                        children: [
                          Container(color: Colors.grey,child: Image.network(trendingArticlList[index].articleImg),),
                          Wrap(
                            crossAxisAlignment: WrapCrossAlignment.end,
                            // mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                       ...
                       leading: Image.network(trendingArticlList[index].articleImg),
                       title: Wrap(
                          crossAxisAlignment: WrapCrossAlignment.end,
                          // mainAxisAlignment: MainAxisAlignment.start,
                          children: [
  ...
  Widget _exploreArticle(BuildContext context, List<ExploreArticleEntity>? exploreArticleList){
    return Container(
